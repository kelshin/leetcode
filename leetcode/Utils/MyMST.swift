...
public final class MyMST {
  public static func MyKruskalMST(_ graph: [[(v: Int, w: Int)]]) -> (Int, [(Int, Int, Int)]){
    var allEdges = [(u: Int, v: Int, w: Int)]()
    var mstEdges = [(u: Int, v: Int, w: Int)]()
...
print("edges : ", allEdges)
  ...
  public static func MyTestKruskalMST(_ graph: [[(v: Int, w: Int)]]) -> (Int, [(Int, Int, Int)]){
    var allEdges = [(u: Int, v: Int, w: Int)]()
    var mstEdges = [(u: Int, v: Int, w: Int)]()
